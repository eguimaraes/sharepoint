...
export default class MostraPerfilSharePointWebPart extends BaseClientSideWebPart<IMostraPerfilSharePointWebPartProps> {
  ...
  private _getListData(): Promise<IDado> {
    ...
    return this.context.spHttpClient.get(this.context.pageContext.web.absoluteUrl + `/_api/search/query?querytext='*'&SelectProperties='AboutMe,AccountName,UserProfile_GUID,LastModifiedTime,OriginalPath,Path,PreferredName,ServiceApplicationID,WorkEmail,PictureURL,SipAddress,UserLocation,RefinableDate00,RefinableDate01'&TrimDuplicates=true&SourceId='B09A7990-05EA-4AF9-81EF-EDFAB16C4E31'&rowsperpage=100&RowLimit=300'`, clientConfigODataV3)
